...
public class DriveSubsystem extends SubsystemBase {
    ...
    try{
     ...
     AutoBuilder.configure(
            ...
            /*(chassisSpeeds) -> drive(
               ...
               true,  // Ajuste conforme necessário (ex.: fieldRelative)
               true),   // Ajuste conforme necessário (ex.: rateLimit)*/
  ...
  public void zeroHeading() {
    ...
    pidgey.setYaw(0.0);
    pidgey.setYaw(0.0);
    System.out.println("Pigeon Zerado!!");
  }
  ...
  public double getTurnRate() {
   ...
   /////////// Métodos para teste do autonomo //////////////
